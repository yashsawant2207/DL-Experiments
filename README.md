...
processed_training_data.csv: The fitted and transformed training matrix, including the re-appended target variable.

processed_testing_data.csv: The rigorously transformed testing matrix, modified solely by the parameters learned from the training data.

hotel_booking_preprocessor.joblib: The serialized ColumnTransformer object.
